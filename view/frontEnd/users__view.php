                    ...
                    <div class="col-lg-offset-4 col-md-offset-3 col-lg-4 col-md-6 col-sm-12 col-xs-12">
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                <input class="form-control" name="pseudo" type="text" id="pseudo" min="3" max="50" placeholder="Identifiant" required></input>
                            </div>	

                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                <input class="form-control" name="MDP" type="password" id="mdp" placeholder="Mot de passe" required></input>
                                <span id="aideMdp"></span>
                            </div>

                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                <input class="form-control" name="confirm" type="password" id="confirm" placeholder="Confirmer le mot de passe" required></input>
                            </div>

                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-group">
                                <input class="form-control" name="email" type="email" id="email" placeholder="Adresse e-mail" required></input>
                            </div>
