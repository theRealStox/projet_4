<?php
require('model/users__model.php');
        ...
        if (USER_IS_CO === 1) {
            ...
            if (isset($_POST['pseudo']))
            {
                if (empty($_POST['pseudo']) || empty($_POST['password']) )
                {
                    ...
                    $getUserLogs = getUserLogs($pseudoPost);
                    ...
                    while ($data = $getUserLogs->fetch())
                    {
                        if ($data['JF_user_pass'] == hash('sha512', $_POST['password']) AND $data['JF_user_confirmAccount'] == 1)
                        {
                            ...
                            $getUserRole = getUserRole($_SESSION['pseudo']);
    ...
    */
    ...
    elseif ($_GET['f'] === 'iv') {
            ...
            ) 
        {
            ...
            $pseudo_free = user__newUserVerif__pseudo($pseudo);
            $mail_free = user__newUserVerif__email($email);
            ...
            if ($i === 0) {
                ...
                $addUser = user__newUserInsert($pseudo, $uniqueID, $mdp_hash, $email);

                if ($addUser == true) 
                {
                    /*
                    echo'
                    <section class="coreBlock DC JC container">
                        <div class="text-center">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="jumbotron alert-success">
                                        <h6 class="">
                                            Votre demande d\'inscription a été réalisée avec succès. 
                                        </h6>
                                        <h6><a class="btn btn-success nsl" href="index.php?v=u">Retour menu utilisateur</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                {
                    //echo'Erreur pas d\'import en BDD';
...
//} else {
    ...
    */
    ...
    elseif ($_GET['f'] === 'mu') {
        ...
        require('view/body/user/menuUser.php');
        
    }	
    
//}	   

require('view/frontEnd/users__view.php');
